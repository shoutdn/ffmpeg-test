...
static int encode(AVCodecContext* enc_ctx, AVFrame* frame, AVPacket* pkt,
    ...
    while (ret >= 0) {
        ...
        if (pkt->flags & AV_PKT_FLAG_KEY)
            printf("Write packet flags:%d pts:%3d dts:%3d (size:%5d)\n",
...
int encodevideo() {
    ...
    in_yuv_file = "D:\\vsProject\\Project1\\60s_h264.rawdata";     // 输入YUV文件
    out_h264_file = "D:\\vsProject\\Project1\\60s_h264_encode.mp4";
    codec_name = "libx264";
